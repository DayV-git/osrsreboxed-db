...
Description:
Script to fetch and process OSRS Wiki pages for Category:Items.
...
def fetch():
    """Get all the wiki category page titles and page text for items."""
...
def process():
    """Process wiki page text and extract item infobox data."""
    wiki_props = WikiProperties(
        categories=["Items", "Pets"],
        template_names=["infobox item", "infobox pet"],
        titles_filepath=Path(config.DATA_ITEMS_PATH / "items-wiki-page-titles.json"),
